...
TRANSLATIONS = {
    ...
    "russian": {
        ...
        "episode": "Эпизод",
        "ep_1": "DEUS EX MACHINA",
        "ep_2": "ЭТО БЫЛО ПОСЛЕДНЕЕ МЕСТО, ГДЕ ВИДЕЛИ МОЕГО ОТЦА",
        "ep_3": "КОГДА-ТО ТЫ ОСТАВИЛ МНЕ ЭТО",
        "ep_4": "БОЙ ОКОНЧЕН",
        "ep_5": "НАВЕРНОЕ, Я НАУЧУ ТЕБЯ ГОТОВИТЬ",
        "ep_6": "В ЛЮБОЕ ВРЕМЯ, КОГДА УГОДНО",
        "ep_7": "ВЕРНУЛСЯ ДОМОЙ И УЗНАЛ ПЛОХИЕ НОВОСТИ",
        "ep_8": "НЕ УХОДИ",
        "ep_9": "ПРЕКРАСНАЯ ТИШИНА ПОСЛЕ ВЗРЫВА",
    ...
    "italiano": {
        ...
        "episode": "Episodio",
        "ep_1": "DEUS EX MACHINA",
        "ep_2": "QUESTO È L'ULTIMO POSTO IN CUI È STATO VISTO MIO PADRE",
        "ep_3": "UNA VOLTA MI HAI LASCIATO QUESTO",
        "ep_4": "LOTTA FINITA",
        "ep_5": "ECCO, TI INSEGNERO A CUCINARE",
        "ep_6": "IN QUALSIASI MOMENTO, SEMPRE",
        "ep_7": "SONO TORNATO A CASA E HO TROVATO LA CATTIVA NOTIZIA",
        "ep_8": "NON ANDARE",
        "ep_9": "IL BELLO SILENZIO DOPO IL BOTTO",
